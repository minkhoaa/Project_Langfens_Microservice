...
{
    // public
    Task<ApiResultDto> ListPublishedAsync(string? category, string? level, int page, int pageSize,
...
public class ExamService : IExamService
{
    ...
    public async Task<ApiResultDto> ListPublishedAsync(string? category, string? level, int page, int pageSize,
        CancellationToken cancellationToken)
    {
