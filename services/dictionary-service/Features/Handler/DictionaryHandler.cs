...
namespace dictionary_service.Features.Handler
{
    public static class DictionaryHandler
    {
        ...
        public static Task<IResult> ImportHandler([FromBody] ImportRequest req, CancellationToken ct, [FromServices] IDictionaryService service) => service.Import(req, ct);
    }
}