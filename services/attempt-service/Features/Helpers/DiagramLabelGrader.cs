...
/// <summary>
/// Grader for <c>DIAGRAM_LABEL</c>. Wire shape is identical to the completion types:
...
/// </summary>
public sealed class DiagramLabelGrader(ITextNormalizer normalizer) : IGrader
{
    public string Slug => "DIAGRAM_LABEL";

    private static readonly JsonSerializerOptions Opts = new(JsonSerializerDefaults.Web);

    public GradeResult Grade(AnswerEnvelope learner, AnswerEnvelope correct, NormalizationConfig norm)
    {
        var correctAns = (DiagramLabelAnswer)correct.TypedRecord;
