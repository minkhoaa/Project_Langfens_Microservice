...
Fixed schema to match invariants.py expectations:
- questions at root level
- instruction_md field name
"""
...
questions.append({
    ...
    "prompt_md": "Which TWO changes have been made so far during the refurbishment of the theatre? (Answer 1 of 2)",
...
questions.append({
    "idx": 2,
    "type": "MULTIPLE_CHOICE_SINGLE",
    "prompt_md": "Which TWO changes have been made so far during the refurbishment of the theatre? (Answer 2 of 2)",
...
questions.append({
    "idx": 3,
    "type": "MULTIPLE_CHOICE_SINGLE", 
    "prompt_md": "Which TWO facilities does the theatre currently offer to the public? (Answer 1 of 2)",
...
questions.append({
    "idx": 4,
    "type": "MULTIPLE_CHOICE_SINGLE",
    "prompt_md": "Which TWO facilities does the theatre currently offer to the public? (Answer 2 of 2)",
...
questions.append({
    "idx": 5,
    "type": "MULTIPLE_CHOICE_SINGLE",
    "prompt_md": "Which TWO workshops does the theatre currently offer? (Answer 1 of 2)",
...
questions.append({
    "idx": 6,
    "type": "MULTIPLE_CHOICE_SINGLE",
    "prompt_md": "Which TWO workshops does the theatre currently offer? (Answer 2 of 2)",
    ...
    "sections": [
        {
            ...
            "instruction_md": """**Questions 1-6:** Choose TWO letters, A-E.
