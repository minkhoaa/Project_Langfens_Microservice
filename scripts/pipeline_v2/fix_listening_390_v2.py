...
Issues:
1. "Choose TWO" questions → split to MCQ_SINGLE
2. Passage too short → use full transcript
3. Q7-10 need proper MATCHING_INFORMATION format
"""
...
# Constants
BASE_DIR = Path("/home/khoa/RiderProjects/Project_Langfens_Microservice/scripts/pipeline_v2")
DATA_DIR = BASE_DIR / "data"
ITEM_ID = "390-new-staff-at-theatre"

# Create output directory structure
for subdir in ["cleaned", "normalized", "extracted"]:
    (DATA_DIR / subdir / "mini-ielts").mkdir(parents=True, exist_ok=True)
