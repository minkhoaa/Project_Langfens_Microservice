...
export default function Flashcard({
  ...
  return (
    <div className="relative mx-auto h-[360px] max-w-2xl perspective">
      <div
        className={`relative h-full w-full rounded-2xl border bg-white shadow-sm
      ...
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-8 [backface-visibility:hidden]">
          ...
          <button
            onClick={onFlip}
            className="mt-6 rounded-lg border border-indigo-200 px-3 py-1.5
            text-sm text-indigo-700 hover:bg-indigo-50"
          >
            Lật thẻ
          </button>
        </div>
