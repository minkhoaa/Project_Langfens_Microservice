...
-- Section 4: Speaking (Audio Response)
INSERT INTO exam_sections ("Id","ExamId","Idx","Title","InstructionsMd","AudioUrl","TranscriptMd")
VALUES ('d8e52f30-1a4b-4c3d-9e6a-7f9b0c1d2e3f', 'c69a3e54-a7f1-40eb-ab69-1f50ca798267', 4, 'Speaking – Audio Response', 'In this section, you will answer a speaking question by recording your voice.
You have **2 minutes** to prepare and **2 minutes** to record your answer.
Speak clearly and try to use a variety of vocabulary and grammar structures.', NULL, NULL);
INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'd8e52f30-1a4b-4c3d-9e6a-7f9b0c1d2e3f', 1, 'AUDIO_RESPONSE', 'SPEAKING', 3, '### Speaking Task
...
You may use your own experience to support your ideas.', NULL, ARRAY['.*']);
