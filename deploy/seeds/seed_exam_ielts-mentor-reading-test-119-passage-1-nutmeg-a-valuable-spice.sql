...
BEGIN
  ...
  VALUES (
    ...
    E'## Questions 1-4\n\nComplete the notes below.\n\nChoose **ONE WORD ONLY** from the passage for each answer.\n\n### The nutmeg tree and fruit\n\n- the leaves of the tree are **1** [1] in shape\n- the **2** [2] surrounds the fruit and breaks open when the fruit is ripe\n- the **3** [3] is used to produce the spice nutmeg\n- the covering known as the aril is used to produce **4** [4]\n- the tree has yellow flowers and fruit\n\n---\n\n## Questions 5-7\n\nDo the following statements agree with the information given in Reading Passage?\n\nWrite:\n- **TRUE** if the statement agrees with the information\n- **FALSE** if the statement contradicts the information\n- **NOT GIVEN** if there is no information on this\n\n**5.** In the Middle Ages, most Europeans knew where nutmeg was grown.\n\n**6.** The VOC was the world''s first major trading company.\n\n**7.** Following the Treaty of Breda, the Dutch had control of all the islands where nutmeg grew.\n\n---\n\n## Questions 8-13\n\nComplete the table below.\n\nChoose **ONE WORD ONLY** from the passage for each answer.\n\n| Date | Event |\n|------|-------|\n| Before 1512 | The **8** [5] held a monopoly on nutmeg trading with Europe |\n| 1602 | Dutch East India Company founded; the **9** [6] disease led to increased demand |\n| 1621 | Dutch take control, cover nutmeg with **10** [7] to prevent cultivation elsewhere |\n| 1667 | Treaty of Breda: island of **11** [8] exchanged for Manhattan |\n| 1770 | Pierre Poivre smuggled nutmeg to **12** [9] |\n| 1778 | A **13** [10] destroyed half the nutmeg groves |',
  ...
  VALUES (
    ...
    'READING',
    2,
    'the [1] surrounds the fruit and breaks open when the fruit is ripe',
  ...
  VALUES (
    ...
    'READING',
    2,
    'the [1] is used to produce the spice nutmeg',
  ...
  VALUES (
    ...
    'READING',
    2,
    'the covering known as the aril is used to produce [1]',
  ...
  VALUES (
    ...
    'READING',
    2,
    'Before 1512, the [1] held a monopoly on nutmeg trading with Europe.',
  ...
  VALUES (
    ...
    'READING',
    2,
    'The [1] disease led to increased European demand for nutmeg.',
  ...
  VALUES (
    ...
    'READING',
    2,
    'The Dutch covered exported nutmeg with [1] to prevent its cultivation elsewhere.',
  ...
  VALUES (
    ...
    'READING',
    2,
    'The island of [1] was exchanged for Manhattan.',
  ...
  VALUES (
    ...
    'READING',
    2,
    'Pierre Poivre smuggled nutmeg plants to [1].',
  ...
  VALUES (
    ...
    'READING',
    2,
    'A [1] destroyed half the nutmeg groves in the Banda region.',
  ...
  INSERT INTO exam_question_groups ("Id","SectionId","Idx","StartIdx","EndIdx","InstructionMd")
  VALUES (gen_random_uuid(), sec1, 3, 8, 13, E'## Questions 8-13\n\nComplete the table below.\n\nChoose **ONE WORD ONLY** from the passage for each answer.\n\n| Date | Event |\n|------|-------|\n| Before 1512 | The **8** [1] held a monopoly on nutmeg trading with Europe |\n| 1602 | Dutch East India Company founded; the **9** [2] disease led to increased demand |\n| 1621 | Dutch take control, cover nutmeg with **10** [3] to prevent cultivation elsewhere |\n| 1667 | Treaty of Breda: island of **11** [4] exchanged for Manhattan |\n| 1770 | Pierre Poivre smuggled nutmeg to **12** [5] |\n| 1778 | A **13** [6] destroyed half the nutmeg groves |');
