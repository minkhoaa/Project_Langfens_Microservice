...
BEGIN
  ...
  VALUES (
    ...
    'READING',
    2,
    'The writer has experience of a large number of [1]',
    '',
    '{"1": ["EXPEDITIONS"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'and was the first stranger that certain previously [1] people had encountered.',
    '',
    '{"1": ["UNCONTACTED"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'He believes there is no need for further exploration of Earth''s [1]',
    '',
    '{"1": ["SURFACE"]}'::jsonb
  );
