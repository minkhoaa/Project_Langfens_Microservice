...
-- Cleanup existing data for slug: ielts-mentor-gt-reading-8-section-3-a-very-special-dog
DELETE FROM exam_options WHERE "QuestionId" IN (
  SELECT q."Id" FROM exam_questions q
  JOIN exam_sections s ON s."Id" = q."SectionId"
  JOIN exams e ON e."Id" = s."ExamId"
  WHERE e."Slug" = 'ielts-mentor-gt-reading-8-section-3-a-very-special-dog'
);
DELETE FROM exam_questions USING exam_sections s, exams e
WHERE exam_questions."SectionId" = s."Id"
  AND s."ExamId" = e."Id"
  AND e."Slug" = 'ielts-mentor-gt-reading-8-section-3-a-very-special-dog';
DELETE FROM exam_sections USING exams e
WHERE exam_sections."ExamId" = e."Id"
  AND e."Slug" = 'ielts-mentor-gt-reading-8-section-3-a-very-special-dog';
DELETE FROM exams
WHERE "Slug" = 'ielts-mentor-gt-reading-8-section-3-a-very-special-dog';
...
BEGIN
  ...
  VALUES (
    exam_id,
    'ielts-mentor-gt-reading-8-section-3-a-very-special-dog',
    'GT Reading 8 Section 3 - A very special Dog',
