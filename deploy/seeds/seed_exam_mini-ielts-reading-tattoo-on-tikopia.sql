...
BEGIN
  ...
  VALUES (
    ...
    'READING',
    2,
    'Material for container: [1]',
    '',
    '{"1": ["coconut shell"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    '[1] of male face: general rank',
    '',
    '{"1": ["the forehead"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'Female''s right side of the face: [1]',
    '',
    '{"1": ["mothers ancestry"]}'::jsonb
  );
