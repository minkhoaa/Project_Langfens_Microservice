...
-- Generated: 2025-12-24T13:33:42.946025
-- Source: mini-ielts.com
-- Title: Tattoo on Tikopia
-- ============================================

BEGIN;
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Cleanup existing data for slug: mini-ielts-reading-tattoo-on-tikopia
DELETE FROM exam_options WHERE "QuestionId" IN (
  SELECT q."Id" FROM exam_questions q
  JOIN exam_sections s ON s."Id" = q."SectionId"
  JOIN exams e ON e."Id" = s."ExamId"
  WHERE e."Slug" = 'mini-ielts-reading-tattoo-on-tikopia'
);
DELETE FROM exam_questions USING exam_sections s, exams e
WHERE exam_questions."SectionId" = s."Id"
  AND s."ExamId" = e."Id"
  AND e."Slug" = 'mini-ielts-reading-tattoo-on-tikopia';
DELETE FROM exam_sections USING exams e
WHERE exam_sections."ExamId" = e."Id"
  AND e."Slug" = 'mini-ielts-reading-tattoo-on-tikopia';
DELETE FROM exams
WHERE "Slug" = 'mini-ielts-reading-tattoo-on-tikopia';
...
BEGIN
  ...
  VALUES (
    exam_id,
    'mini-ielts-reading-tattoo-on-tikopia',
    'Tattoo on Tikopia',
    ...
    'PUBLISHED',
    20,
    'https://res.cloudinary.com/df41zs8il/image/upload/v1766556939/ielts/tikopia-mike-moore-1200x630-5__ebc45f01d3b6.jpg',
    now()
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'Material for container: _______',
    '',
    '{"blank-q5": ["coconut shell"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'Tool comb made from: _______',
    '',
    '{"blank-q8": ["heartwood"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'Needle made from: _______',
    '',
    '{"blank-q9": ["wing bone"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    '_______ of male face: general rank',
    '',
    '{"blank-q10": ["the forehead"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    '_______ of male face: prestige',
    '',
    '{"blank-q11": ["chin area"]}'::jsonb
  );
  ...
  VALUES (
    ...
    '',
    '{"blank-q12": ["mothers ancestry"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'Male back: _______',
    '',
    '{"blank-q13": ["vertical lines"]}'::jsonb
  );
