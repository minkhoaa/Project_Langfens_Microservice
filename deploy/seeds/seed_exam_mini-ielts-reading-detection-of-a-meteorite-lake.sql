...
BEGIN
  ...
  VALUES (
    ...
    '{"1": ["SOUND ENERGY", "SOUND WAVE"]}'::jsonb
  );
  ...
  VALUES (
    ...
    '{"1": ["HYDROPHONES", "UNDERWATER MICROPHONES"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'The boat-double R/V Kilindi crossed the lake was dismantled and stored in a [1] .',
  ...
  VALUES (
    ...
    'READING',
    2,
    'The technology they used called [1] ; They created sound energy into 1000-2000 metres into the bottom of the lake and used separate equipment to collect the returned waves.',
    ...
    '{"1": ["SEISMIC REFLECTION PROFILING"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'Then the data had been analyzed and processed in the [1] Scholz also added that they were now building .',
  ...
  VALUES (
    ...
    'READING',
    2,
    'Then the data had been analyzed and processed in the Scholz also added that they were now building [1] .',
  ...
  VALUES (
    ...
    'READING',
    2,
    'The whole set of equipment works well yet the ship should avoid physical barrier including tree stumps or [1] .',
  ...
  INSERT INTO exam_question_groups ("Id","SectionId","Idx","StartIdx","EndIdx","InstructionMd")
  VALUES (gen_random_uuid(), sec1, 2, 6, 14, E'## Questions 6-14\n\nComplete the sentences below.\n\nWrite **NO MORE THAN TWO WORDS AND/OR A NUMBER** for each answer.\n\n![Diagram](http://images.mini-ielts.com/images/ads/47-ielts-reading-22-v22306-q14-27.jpg)\n\n**6.** [1]\n\n**7.** [2]\n\n**8.** [3]\n\n**9.** [4]\n\n**10.** The boat-double R/V Kilindi crossed the lake was dismantled and stored in a [5] .\n\n**11.** The technology they used called [6] ; They created sound energy into 1000-2000 metres into the bottom of the lake and used separate equipment to collect the returned waves.\n\n**12.** Then the data had been analyzed and processed in the [7] Scholz also added that they were now building .\n\n**13.** Then the data had been analyzed and processed in the Scholz also added that they were now building [8] .\n\n**14.** The whole set of equipment works well yet the ship should avoid physical barrier including tree stumps or [9] .');
