...
create unique index "IX_exams_Slug"
    on exams ("Slug");

INSERT INTO public.exams ("Id", "Slug", "Title", "DescriptionMd", "Category", "Level", "Status", "DurationMin", "CreatedAt", "UpdatedAt") VALUES ('b493d316-6ebc-457f-922f-2e4b358b4a00', 'listeing-test', 'LISTENING TEST', 'string', 'IELTS', 'string', 'DRAFT', 0, '2025-11-17 09:10:35.060634 +00:00', '2025-11-17 09:10:50.361638 +00:00');


create table exam_sections
(
    "Id"             uuid    not null
        constraint "PK_exam_sections"
            primary key,
    "ExamId"         uuid    not null
        constraint "FK_exam_sections_exams_ExamId"
            references exams
            on delete cascade,
...
(
    "Id"         uuid    not null
        constraint "PK_exam_options"
            primary key,
    "QuestionId" uuid    not null
        constraint "FK_exam_options_exam_questions_QuestionId"
...
create index "IX_exam_options_QuestionId_Idx"
    on exam_options ("QuestionId", "Idx");

INSERT INTO public.exam_options ("Id", "QuestionId", "Idx", "ContentMd", "IsCorrect") VALUES ('1a4a736e-a58e-4235-8c4a-0905bb5de0e5', '88cbe75f-bec8-48af-8832-dfb8e4f2e94e', 2, 'Option 2', false);
INSERT INTO public.exam_options ("Id", "QuestionId", "Idx", "ContentMd", "IsCorrect") VALUES ('e6909db1-1239-48ad-9269-b47124464db4', '88cbe75f-bec8-48af-8832-dfb8e4f2e94e', 3, 'Option 1', true);
INSERT INTO public.exam_options ("Id", "QuestionId", "Idx", "ContentMd", "IsCorrect") VALUES ('8e393a33-1310-4883-b0c0-82b1b8ef3413', '88cbe75f-bec8-48af-8832-dfb8e4f2e94e', 1, 'Option 3', false);
INSERT INTO public.exam_options ("Id", "QuestionId", "Idx", "ContentMd", "IsCorrect") VALUES ('6717a15b-db0b-460a-bc05-284015c47b98', '84e1f3a6-4da1-49b1-b1c0-cca6e9792ce7', 2, 'Option 1', false);
INSERT INTO public.exam_options ("Id", "QuestionId", "Idx", "ContentMd", "IsCorrect") VALUES ('7884b5a1-c788-492c-8b24-2de049362134', '84e1f3a6-4da1-49b1-b1c0-cca6e9792ce7', 1, 'Option 3', true);
