...
BEGIN
  ...
  VALUES (
    ...
    'READING',
    2,
    'Figures from the Transport Research Laboratory indicate that most motor accidents are partly due to [1], so the introduction of driverless vehicles will result in greater safety.',
    '',
    '{"1": ["human error"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'In addition to the direct benefits of automation, it may bring other advantages. For example, schemes for [1] will be more workable, especially in towns and cities, resulting in fewer cars on the road.',
    '',
    '{"1": ["car-sharing"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'According to the University of Michigan Transportation Research Institute, there could be a 43 percent drop in [1] of cars.',
    '',
    '{"1": ["ownership"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'However, this would mean that the yearly [1] of each car would, on average, be twice as high as it currently is.',
    '',
    '{"1": ["mileage"]}'::jsonb
  );
