...
-- Generated: 2025-12-20T16:40:59.915811
-- Source: ielts-mentor.com
-- Title: GT Reading 9 Section 1 - Summer activities & Visit to the parliament
-- ============================================

BEGIN;
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Cleanup existing data for slug: ielts-mentor-gt-reading-9-section-1-summer-activities-visit-to-the-parliament
DELETE FROM exam_options WHERE "QuestionId" IN (
  SELECT q."Id" FROM exam_questions q
  JOIN exam_sections s ON s."Id" = q."SectionId"
  JOIN exams e ON e."Id" = s."ExamId"
  WHERE e."Slug" = 'ielts-mentor-gt-reading-9-section-1-summer-activities-visit-to-the-parliament'
);
DELETE FROM exam_questions USING exam_sections s, exams e
WHERE exam_questions."SectionId" = s."Id"
  AND s."ExamId" = e."Id"
  AND e."Slug" = 'ielts-mentor-gt-reading-9-section-1-summer-activities-visit-to-the-parliament';
DELETE FROM exam_sections USING exams e
WHERE exam_sections."ExamId" = e."Id"
  AND e."Slug" = 'ielts-mentor-gt-reading-9-section-1-summer-activities-visit-to-the-parliament';
DELETE FROM exams
WHERE "Slug" = 'ielts-mentor-gt-reading-9-section-1-summer-activities-visit-to-the-parliament';
...
BEGIN
  ...
  VALUES (
    exam_id,
    'ielts-mentor-gt-reading-9-section-1-summer-activities-visit-to-the-parliament',
    'GT Reading 9 Section 1 - Summer activities & Visit to the parliament',
  ...
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 5, 'E', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 6, 'F', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 7, 'G', true);
