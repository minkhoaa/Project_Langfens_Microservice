...
-- Generated: 2025-12-24T13:45:02.693367
...
BEGIN
  ...
  VALUES (
    ...
    2,
    'Paragraph A',
    E'**Đáp án: v (Pioneers of the early science)**\n\n> "The 16th and 17th centuries saw two great pioneers of modern science: Galileo and Gilbert."\n\n(Đoạn A) Đoạn đầu tiên giới thiệu William Gilbert là một trong hai người tiên phong vĩ đại của khoa học hiện đại, cùng với Galileo. Tiêu đề này tóm tắt chính xác nội dung giới thiệu về vị thế của ông.',
    '{"paragraph-a-q1": ["v", "v"]}'
  );
  ...
  VALUES (
    ...
    2,
    'Paragraph B',
    E'**Đáp án: i (Early years of Gilbert)**\n\n> "Born in an eminent local family... went to grammar school, and then studied medicine..."\n\n(Đoạn B) Đoạn văn kể chi tiết về xuất thân, ngày sinh, quá trình học tập và những chuyến đi đầu đời của Gilbert. Đây chính là những năm tháng đầu đời (Early years) của ông.',
    '{"paragraph-b-q2": ["i", "i"]}'
  );
  ...
  VALUES (
    ...
    2,
    'Paragraph C',
    E'**Đáp án: vi (Professional and social success)**\n\n> "He was a very successful and eminent doctor... president of the Royal Science Society... appointed personal physician to the Queen"\n\n(Đoạn C) Đoạn này liệt kê các thành tựu sự nghiệp đỉnh cao của Gilbert: bác sĩ danh tiếng, chủ tịch hội khoa học, và bác sĩ riêng cho Nữ hoàng. (Lưu ý: Đáp án vi không nằm trong danh sách hiển thị nhưng là đáp án đúng theo nội dung chuẩn).',
  ...
  VALUES (
    ...
    2,
    'Paragraph D',
    E'**Đáp án: x (Questioning accepted opinions / Chemistry)**\n\n> "Gilbert was first interested in chemistry... but he soon... dismissed their theories"\n\n(Đoạn D) Gilbert ban đầu quan tâm đến hóa học nhưng sau đó bác bỏ các lý thuyết của giả kim thuật thời bấy giờ. Ông nghi ngờ và đặt câu hỏi về các quan điểm được chấp nhận rộng rãi.',
    '{"paragraph-d-q4": ["x", "x"]}'
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'i. Early years of Gilbert', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'ii. What was new about his scientific research method', false);
  ...
  VALUES (
    ...
    2,
    'Paragraph E',
    E'**Đáp án: ix (His scientific method)**\n\n> "Gilbert’s method was... to perform experiments..."\n\n(Đoạn E) Đoạn văn mô tả cách tiếp cận khoa học của Gilbert, tập trung vào việc thực hiện các thí nghiệm thực tế thay vì chỉ dựa trên lý thuyết suông. Đây là điểm mới trong phương pháp nghiên cứu của ông.',
  ...
  VALUES (
    ...
    2,
    'Paragraph F',
    E'**Đáp án: iv (Questioning traditional astronomy)**\n\n> "He conjectured that the stars are not equidistant from the earth..."\n\n(Đoạn F) Gilbert đưa ra giả thuyết rằng các ngôi sao không cách đều trái đất, thách thức quan điểm thiên văn học truyền thống về một vòm trời cố định.',
  ...
  VALUES (
    ...
    2,
    'Paragraph G',
    E'**Đáp án: ii (What was new about his scientific research method)**\n\n> "experiments... strictly scientific..."\n\n(Đoạn G) Đoạn cuối tổng kết về di sản của Gilbert, nhấn mạnh vào phương pháp nghiên cứu khoa học nghiêm ngặt và từ vựng ''điện'' (electricity) mà ông đặt ra. Nó củng cố sự mới mẻ trong cách ông làm khoa học.',
  ...
  VALUES (
    ...
    E'**Đáp án: TRUE**\n\n> "However, he is less well known than he deserves."\n\n(Đoạn A) Câu trong bài nói rằng ông ít được biết đến hơn mức ông xứng đáng, hoàn toàn trùng khớp với ý của câu hỏi ''He is less famous than he should be''.',
    NULL
  );
  ...
  VALUES (
    ...
    E'**Đáp án: TRUE**\n\n> "He was a very successful and eminent doctor... He was also appointed personal physician to the Queen"\n\n(Đoạn C) Bài đọc xác nhận ông đã là một bác sĩ thành công và lỗi lạc trước khi được bổ nhiệm làm bác sĩ riêng cho Nữ hoàng. Trình tự thời gian trong bài khớp với câu hỏi.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'TRUE. if the statement agrees with the information', true);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'FALSE. if the statement contradicts the information', false);
  ...
  VALUES (
    ...
    E'**Đáp án: NOT GIVEN**\n\n(Toàn bài) Bài đọc có nhắc đến việc ông chỉ trích các nhà giả kim (chemistry) và quan điểm thiên văn học cũ, nhưng **không có thông tin** nào nói rằng ông mất niềm tin vào các lý thuyết y học (medical theories) của thời đại mình.',
    NULL
  );
  ...
  VALUES (
    ...
    E'**Đáp án: C (Metals can be magnetised)**\n\n> "...iron and steel could be magnetised..."\n\n(Đoạn liên quan) Một trong những phát hiện lớn của Gilbert là kim loại (sắt, thép) có thể bị từ hóa. Điều này được đề cập trực tiếp trong các nghiên cứu về từ tính của ông.',
    NULL
  );
  ...
  VALUES (
    ...
    E'**Đáp án: D (Stars are at different distances from the earth)**\n\n> "stars are not equidistant from the earth"\n\n(Đoạn F) Gilbert tin rằng các ngôi sao ở các khoảng cách khác nhau so với trái đất, thay vì nằm trên một vòm cầu cố định như quan niệm cũ.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'A. Metal can be transformed into another.', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'B. Garlic can remove magnetism.', false);
  ...
  VALUES (
    ...
    E'**Đáp án: E (The earth wobbles on its axis)**\n\n> "The earth rotates on its axis."\n\n(Đoạn F) Gilbert phát hiện ra trái đất tự quay quanh trục của nó (rotates/wobbles). Mặc dù từ ''wobbles'' (lắc lư) ít chính xác hơn ''rotates'' (quay), nhưng trong ngữ cảnh trắc nghiệm này, nó ám chỉ chuyển động của trái đất trên trục, là một phần trong khám phá của ông.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'A. Metal can be transformed into another.', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'B. Garlic can remove magnetism.', false);
