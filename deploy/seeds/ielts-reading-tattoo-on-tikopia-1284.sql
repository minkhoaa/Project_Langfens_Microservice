...
DELETE FROM exam_options WHERE "QuestionId" IN (
  ...
  WHERE e."Slug" = 'ielts-reading-tattoo-on-tikopia-1284'
);
DELETE FROM exam_questions USING exam_sections s, exams e
WHERE exam_questions."SectionId" = s."Id"
  AND s."ExamId" = e."Id"
  AND e."Slug" = 'ielts-reading-tattoo-on-tikopia-1284';
DELETE FROM exam_sections USING exams e
WHERE exam_sections."ExamId" = e."Id"
  AND e."Slug" = 'ielts-reading-tattoo-on-tikopia-1284';
DELETE FROM exams WHERE "Slug" = 'ielts-reading-tattoo-on-tikopia-1284';

INSERT INTO exams ("Id","Slug","Title","DescriptionMd","Category","Level","Status","DurationMin","CreatedAt")
VALUES ('21ab1728-4263-523f-aa56-f811aaeb0474', 'ielts-reading-tattoo-on-tikopia-1284', $t$Tattoo on Tikopia$t$, $md$## Tattoo on Tikopia

Nguồn:
- Test: https://mini-ielts.com/1284/reading/tattoo-on-tikopia
- Solution: https://mini-ielts.com/1284/view-solution/reading/tattoo-on-tikopia$md$, 'IELTS', 'B2', 'PUBLISHED', 20, now());

INSERT INTO exam_sections ("Id","ExamId","Idx","Title","InstructionsMd","AudioUrl","TranscriptMd")
VALUES ('926ab59d-f94f-5bfb-8481-233600e923f4', '21ab1728-4263-523f-aa56-f811aaeb0474', 1, $t$Reading — Tattoo on Tikopia$t$, $md$Read the passage and answer questions **1–14**.

### Passage: Tattoo on Tikopia
...
I. Tattoo was a way of delivering information about its owner. It’s also a traditional method to fetch spiritual power, protection and strength. The Polynesians use this as a sign of character, position and levels in a hierarchy. Polynesian people believe that a person’s mana, their spiritual power or life force, is displayed through their tattoo.$md$, NULL, NULL);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd")
VALUES ('d9d8e0a0-8d24-51a0-a1b7-5be6610a2776', '926ab59d-f94f-5bfb-8481-233600e923f4', 1, 'YES_NO_NOT_GIVEN', 'READING', 2, $md$### Question 1
...
1 ____ Scientists like to do research in Tikopia because this tiny place is of great remoteness.$md$, NULL);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('0319ff3f-601d-5168-8479-a937647d45a2', 'd9d8e0a0-8d24-51a0-a1b7-5be6610a2776', 1, $md$YES$md$, true);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('fbfb0489-64e7-57d1-9ac5-8367d7d853ef', 'd9d8e0a0-8d24-51a0-a1b7-5be6610a2776', 2, $md$NO$md$, false);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('d9c6b6c1-2441-58ce-b899-c674c7d32a26', 'd9d8e0a0-8d24-51a0-a1b7-5be6610a2776', 3, $md$NOT GIVEN$md$, false);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd")
VALUES ('8adc975b-b1d6-5d8c-86e4-89297be5e2a4', '926ab59d-f94f-5bfb-8481-233600e923f4', 2, 'YES_NO_NOT_GIVEN', 'READING', 2, $md$### Question 2
...
2 ____ . Firth was the first scholar to study on Tikopia.$md$, NULL);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('bc9d12ba-af98-5d24-9216-3a3412e3238a', '8adc975b-b1d6-5d8c-86e4-89297be5e2a4', 1, $md$YES$md$, false);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('3dd0c916-7c77-5733-85ed-46f0c38ecf52', '8adc975b-b1d6-5d8c-86e4-89297be5e2a4', 2, $md$NO$md$, true);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('1b6e487b-d83a-5961-ae07-a0e61e14d44d', '8adc975b-b1d6-5d8c-86e4-89297be5e2a4', 3, $md$NOT GIVEN$md$, false);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd")
VALUES ('1a25f9fa-bce3-590a-ac6d-5b81eebe7ec9', '926ab59d-f94f-5bfb-8481-233600e923f4', 3, 'YES_NO_NOT_GIVEN', 'READING', 2, $md$### Question 3
...
3 ____ . Firth studied the culture differences on Tikopia as well as on some other islands of Pacific.$md$, NULL);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('b0359705-70b9-5117-837a-eaf7b5184317', '1a25f9fa-bce3-590a-ac6d-5b81eebe7ec9', 1, $md$YES$md$, false);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('1ce02118-c0b8-5da1-a032-42d59a9d32da', '1a25f9fa-bce3-590a-ac6d-5b81eebe7ec9', 2, $md$NO$md$, false);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('0e2dca60-df4d-50dd-9780-629b87ab5e03', '1a25f9fa-bce3-590a-ac6d-5b81eebe7ec9', 3, $md$NOT GIVEN$md$, true);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd")
VALUES ('fef7ae40-72cc-5e8a-98f3-2450133984cd', '926ab59d-f94f-5bfb-8481-233600e923f4', 4, 'YES_NO_NOT_GIVEN', 'READING', 2, $md$### Question 4
...
4 ____ The English word ‘tattoo’ is evolved from the local language of the island.$md$, NULL);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('cf84929e-b0ff-570e-8b70-12b2f36ae223', 'fef7ae40-72cc-5e8a-98f3-2450133984cd', 1, $md$YES$md$, true);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('64eba031-85e0-5ddb-9fcb-2117195242c8', 'fef7ae40-72cc-5e8a-98f3-2450133984cd', 2, $md$NO$md$, false);
INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect")
VALUES ('c9e91cea-8f8b-50cf-9257-781890631255', 'fef7ae40-72cc-5e8a-98f3-2450133984cd', 3, $md$NOT GIVEN$md$, false);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('f49e46fa-7606-508a-8612-426430963b2e', '926ab59d-f94f-5bfb-8481-233600e923f4', 5, 'SHORT_ANSWER', 'READING', 3, $md$### Question 5
...
5 ____$md$, NULL, ARRAY['.*coconut.*shell.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('c04f845e-e636-5733-8c89-7fef49476c2a', '926ab59d-f94f-5bfb-8481-233600e923f4', 6, 'SHORT_ANSWER', 'READING', 3, $md$### Question 6
...
6 ____$md$, NULL, ARRAY['.*soot.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('fdcac952-343d-58d2-acde-df98d8d3fdff', '926ab59d-f94f-5bfb-8481-233600e923f4', 7, 'SHORT_ANSWER', 'READING', 3, $md$### Question 7
...
7 ____$md$, NULL, ARRAY['.*liquid.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('844e69d2-b86e-5d5d-91aa-2c8416797b69', '926ab59d-f94f-5bfb-8481-233600e923f4', 8, 'SHORT_ANSWER', 'READING', 3, $md$### Question 8
...
8 ____$md$, NULL, ARRAY['.*hear.*wood.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('33b26c26-85d6-594f-80cf-7527783ff559', '926ab59d-f94f-5bfb-8481-233600e923f4', 9, 'SHORT_ANSWER', 'READING', 3, $md$### Question 9
...
9 ____$md$, NULL, ARRAY['.*wing.*bone.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('56c0a015-b1fa-572f-b9c1-dbc7267f8be6', '926ab59d-f94f-5bfb-8481-233600e923f4', 10, 'NOTE_COMPLETION', 'READING', 4, $md$### Question 10
...
-
10
of male face: general rank
-
11
of male face: prestige
...
- 10 ____ of male face: general rank$md$, NULL, ARRAY['.*the.*forehead.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('10fe46a3-5908-52f9-8e43-a5a141d23ad8', '926ab59d-f94f-5bfb-8481-233600e923f4', 11, 'NOTE_COMPLETION', 'READING', 4, $md$### Question 11
...
- 11 ____ of male face: prestige$md$, NULL, ARRAY['.*chin.*area.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('88391441-4987-5bee-a3f5-4819c816219e', '926ab59d-f94f-5bfb-8481-233600e923f4', 12, 'NOTE_COMPLETION', 'READING', 4, $md$### Question 12
...
- Female’s right side of the face: 12 ____$md$, NULL, ARRAY['.*mother.*s.*ancestry.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('bc46e7f1-4639-57ff-b403-67e02dd9fa46', '926ab59d-f94f-5bfb-8481-233600e923f4', 13, 'NOTE_COMPLETION', 'READING', 4, $md$### Question 13
...
- Male back: 13 ____$md$, NULL, ARRAY['.*vertical.*lines.*']);

INSERT INTO exam_questions ("Id","SectionId","Idx","Type","Skill","Difficulty","PromptMd","ExplanationMd","ShortAnswerAcceptRegex")
VALUES ('4ffbb701-5b72-50ff-b4b4-64d2087c0c19', '926ab59d-f94f-5bfb-8481-233600e923f4', 14, 'NOTE_COMPLETION', 'READING', 4, $md$### Question 14
...
- Male chest: 14 ____$md$, NULL, ARRAY['.*triangles.*']);
