...
BEGIN
  ...
  VALUES (
    ...
    'READING',
    2,
    'Corn → [1] (separated from raw material)',
    '',
    '{"1": ["starch"]}'::jsonb
  );
  ...
  VALUES (
    ...
    'READING',
    2,
    'Dextrose → Lactic acid (through [1] process)',
    '',
  ...
  VALUES (
    ...
    'READING',
    2,
    'Lactide formed (through [1] process)',
    '',
