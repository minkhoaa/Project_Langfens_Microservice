...
-- Generated: 2025-12-22T15:39:08.733833
...
BEGIN
  ...
  VALUES (
    ...
    E'**Đáp án: D**\n\n> "threats to the glow-worm"\n\nĐoạn D nói về các mối đe dọa đối với đom đóm - như ô nhiễm ánh sáng, mất môi trường sống. Match thông tin với đoạn chứa nội dung về nguy cơ/mối đe dọa.',
    '{"info-q28": ["D", "d"]}'
  );
  ...
  VALUES (
    ...
    E'**Đáp án: B**\n\n> "ways in which glow-worms have been used"\n\nĐoạn B đề cập đến cách đom đóm được sử dụng trong lịch sử - được ghi trong bách khoa toàn thư Trung Quốc cổ, văn hóa Nhật Bản. Đây là ''cách sử dụng'' glow-worm.',
    '{"info-q29": ["B", "b"]}'
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'A', false);
  ...
  VALUES (
    ...
    E'**Đáp án: A**\n\n> "variations in type of glow-worm"\n\nĐoạn A mô tả các biến thể loại đom đóm - khác nhau về màu sắc, pattern ánh sáng, khoảng cách giữa các xung sáng. Keyword: ''differ'', ''colour'', ''pattern''.',
    '{"info-q30": ["A", "a"]}'
  );
  ...
  VALUES (
    ...
    E'**Đáp án: B**\n\n> "glow-worm distribution"\n\nĐoạn B chứa thông tin về phân bố địa lý của đom đóm - được đề cập trong bách khoa toàn thư Trung Quốc, Nhật Bản, cho thấy chúng phân bố ở châu Á.',
    '{"info-q31": ["B", "b"]}'
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'A', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'B', true);
  ...
  VALUES (
    ...
    E'**Đáp án: E**\n\n> "glow-worms becoming an attraction"\n\nĐoạn E nói về đom đóm trở thành điểm thu hút du lịch - ví dụ như hang Waitomo ở New Zealand nơi du khách đến xem đom đóm phát sáng.',
    '{"info-q32": ["E", "e"]}'
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'A', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'B', false);
  ...
  VALUES (
    ...
    E'**Đáp án: C**\n\n> "the life-cycle of a glow-worm"\n\nĐoạn C mô tả vòng đời của đom đóm - từ trứng, ấu trùng, nhộng đến trưởng thành. Keywords: eggs, larvae, pupate, adult.',
    '{"info-q33": ["C", "c"]}'
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'A', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'B', false);
  ...
  VALUES (
    ...
    E'**Đáp án: NOT GIVEN**\n\nThông tin trong câu hỏi không được đề cập trong bài. Không có bằng chứng để xác nhận hoặc phủ nhận statement này.',
    NULL
  );
  ...
  VALUES (
    ...
    E'**Đáp án: FALSE**\n\nThông tin trong câu hỏi mâu thuẫn với bài đọc. Bài viết nói ngược lại với statement - cần đọc kỹ để tìm chi tiết đối lập.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'TRUE', false);
  ...
  VALUES (
    ...
    E'**Đáp án: NOT GIVEN**\n\nThông tin này không được đề cập trong passage. Không thể kết luận TRUE hay FALSE nếu không có evidence.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'TRUE', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'FALSE', false);
  ...
  VALUES (
    ...
    E'**Đáp án: TRUE**\n\nThông tin khớp với bài đọc. Statement được xác nhận bởi nội dung trong passage - tìm câu/đoạn chứng minh.',
    NULL
  );
  ...
  VALUES (
    ...
    E'**Đáp án: FALSE**\n\nStatement mâu thuẫn với nội dung bài đọc. Bài viết nói điều ngược lại - cần identify contradiction.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'TRUE', false);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'FALSE', true);
  ...
  VALUES (
    ...
    E'**Đáp án: TRUE**\n\nStatement được xác nhận bởi passage. Thông tin trong bài đọc support cho nhận định này.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'TRUE', true);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'FALSE', false);
  ...
  VALUES (
    ...
    E'**Đáp án: TRUE**\n\nThông tin phù hợp với bài đọc. Có evidence trong passage chứng minh statement đúng.',
    NULL
  );
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 1, 'TRUE', true);
  INSERT INTO exam_options ("Id","QuestionId","Idx","ContentMd","IsCorrect") VALUES (gen_random_uuid(), qid, 2, 'FALSE', false);
