...
-- Generated: 2025-12-24T13:44:11.933295
...
BEGIN
  ...
  VALUES (
    ...
    'PUBLISHED',
    20,
    'http://images.mini-ielts.com/images/2022/13/undersea-movement_resized.jpg',
    now()
  );
  ...
  VALUES (
    ...
    E'## Questions 1-6\n\nThe Passage has 8 paragraphs A-H.\nWhich paragraph contains the following information?\n\nWrite the appropriate letter, **A-H**, in boxes 1-6.\n\n**1.** categorizations of fish by swimming speed _______\n**2.** an example of fish capable of maintaining fast swimming for a long time _______\n**3.** how fish control stability _______\n**4.** frequency of the muscle movement of fish _______\n**5.** a mechanical model of fish skeleton _______\n**6.** energy storage devices in a fish _______\n\n---\n\n## Questions 7-10\n\nThe diagram below gives information about fish fins and their purposes.\nComplete the diagram with **NO MORE THAN THREE WORDS** from the passage.\n\n![Fish Fins Diagram](https://res.cloudinary.com/df41zs8il/image/upload/ielts/1388_diagram.jpg)\n\n**7.** Tail fin contributes to: _______\n**8.** Median fins control: _______\n**9.** _______ fins act as hydroplanes\n**10.** Paired fins help fish: _______\n\n---\n\n## Questions 11-13\n\nComplete the summary below using **NO MORE THAN THREE WORDS** from the passage.\n\nTwo types of muscles are involved in fish swimming. The majority of a fish''s body comprises the **11** _______, and the red muscle is found only at the roots of the fins and in a strip along the centre of each flank. For most of its routine movements, the fish uses a lot of its **12** _______ saved in body, and white muscle is mostly used for short-term, fast swimming, such as escaping from **13** _______.\n',
